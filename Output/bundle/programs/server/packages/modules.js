...
install("ohif:log");
install("ohif:commands");
install("iron:core");
install("iron:dynamic-template");
install("iron:layout");
install("clinical:router-url");
install("clinical:router-middleware-stack");
install("clinical:router-location");
install("iron:controller");
install("clinical:router");
install("amplify");
install("cultofcoders:persistent-session");
install("ohif:hotkeys");
install("ohif:header");
install("ohif:cornerstone");
install("ohif:cornerstone-settings");
install("momentjs:moment");
install("ohif:viewerbase");
...
install("ohif:metadata");
install("ohif:google-cloud");
install("ohif:demo-mode");
install("ohif:user-oidc");
install("aldeed:template-extension");
install("ohif:select-tree");
install("ohif:measurements");
install("ohif:measurement-table");
install("fortawesome:fontawesome");
install("johdirr:meteor-git-rev");
